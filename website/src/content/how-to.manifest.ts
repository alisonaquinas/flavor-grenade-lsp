...
export const howToManifest = definePageGroupManifest({
  ...
  entries: [
    ...
    {
      routeId: "howToUseLlmSkill",
      group: "how-to",
      copy: "how-to/use-llm-skill-plugin.md",
      order: 3,
      output: "pages",
    },
    {
    ...
    {
      routeId: "howToChooseMarkdownFlavor",
      group: "how-to",
      copy: "how-to/choose-a-markdown-flavor.md",
      order: 5,
      output: "pages",
    },
    {
      routeId: "howToUseStructuredProfiles",
      group: "how-to",
      copy: "how-to/use-structured-profiles.md",
      order: 6,
      output: "pages",
    },
    {
    ...
    {
      routeId: "howToUseCodeActions",
      group: "how-to",
      copy: "how-to/use-code-actions.md",
      order: 8,
      output: "pages",
    },
    {
