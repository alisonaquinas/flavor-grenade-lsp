...
> Extension phase E8 is **complete** as of 2026-05-07. Extension phase E9 is **in review** for the extension-host regression harness.
...
| E9 | Extension Host Regression Harness | in-review | Extension-host tests for activation, language mode, commands, status, and failure states | — |
