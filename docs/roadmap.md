...
| W8 | Commonloom Content Pipeline | in-progress | Markdown copy, typed manifests, reusable Commonloom compiler, generated TypeScript records, and migration gates replace hand-authored content modules | — |
