...
| **MarkdownFlavorSelection** | BC6 Editor Client | The selected Markdown dialect for a `markdown` document. Initial values are `auto`, `original`, `commonmark`, and `obsidian`. |
