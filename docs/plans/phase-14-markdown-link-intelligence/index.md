...
| [[TASK-158]] | Index Markdown link references in RefGraph | Task | `in-review` |
| [[TASK-159]] | Resolve Markdown links through Oracle | Task | `in-review` |
| [[TASK-160]] | Diagnose Markdown heading anchors | Task | `in-review` |
| [[TASK-161]] | Navigate Markdown links and labels | Task | `in-review` |
| [[TASK-162]] | Rename Markdown heading anchors | Task | `in-review` |
| [[CHORE-044]] | Phase 14 Lint Sweep | Chore | `in-review` |
| [[BUG-002]] | Markdown index fields crash legacy OFMDoc fixtures | Bug | `in-review` |
