...
| [[BUG-006]] | BDD smoke indexes files outside configured extension list | Bug | `in-progress` |
| [[BUG-007]] | BDD smoke includes undefined extension-host scenario | Bug | `in-progress` |
