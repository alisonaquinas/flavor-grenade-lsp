...
| [[BUG-003]] | Markdown path targets can escape above vault root | Bug | `triaged` |
| [[BUG-004]] | Malformed Markdown anchor escapes can crash heading resolution | Bug | `triaged` |
| [[BUG-005]] | Markdown completions lose folder context for nested documents | Bug | `triaged` |
