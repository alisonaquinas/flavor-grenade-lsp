...
- See also: [[docs/adr/ADR002-ofm-only-scope]]
...
|---|---|---|
| — | Single-file mode requirements | [[docs/requirements/index]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Scope of OFM-only diagnostics; cross-file codes suppressed in single-file mode |
| [[docs/adr/ADR003-vault-detection]] | Vault detection modes and single-file fallback behaviour |
