...
> [!INFO] `TASK-035` · Task · Phase 3 · Parent: [[FEAT-004]] · Status: `open`
...
- [[TASK-030]] — `WikiLinkEntry` and `OpaqueRegion` types must be defined
- [[TASK-040]] — `OpaqueRegionMarker` must be available to provide opaque regions

**Unblocks:**

- [[TASK-041]] — `OFMParser` orchestrator calls `WikiLinkParser` in Stage 3
