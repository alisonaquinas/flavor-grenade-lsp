...
|---|---|---|
| — | Full OFM parse pipeline for a single document | [[docs/plans/phase-03-ofm-parser]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR012-parser-safety-policy]] | No I/O in parser; no ReDoS; bounded input; pure function |
