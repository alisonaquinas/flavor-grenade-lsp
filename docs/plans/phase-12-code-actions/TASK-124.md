...
> [!INFO] `TASK-124` · Task · Phase 12 · Parent: [[tickets/FEAT-013]] · Status: `open`
...
|---|---|
| [[bdd/features/code-actions]] | `textDocument/documentSymbol returns hierarchical heading tree` |
