...
|---|---|---|
| — | Vault-wide symbol search by query string | [[docs/requirements/functional/wiki-link-resolution]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Symbol search restricted to OFM-indexed entities |
