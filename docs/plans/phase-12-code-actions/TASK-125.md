...
> [!INFO] `TASK-125` · Task · Phase 12 · Parent: [[FEAT-013]] · Status: `open`
...
|---|---|
| `bdd/features/code-actions.feature` | `Semantic tokens returned for wiki-links and tags` |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Semantic tokens cover only OFM syntax elements, not standard Markdown |
