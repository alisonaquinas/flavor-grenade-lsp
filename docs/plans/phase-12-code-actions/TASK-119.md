...
- See also: [[docs/adr/ADR005-wiki-style-binding]], [[docs/adr/ADR013-vault-root-confinement]]
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR005-wiki-style-binding]] | File path determination follows configured linkStyle |
| [[docs/adr/ADR013-vault-root-confinement]] | New file URI must be constructed relative to vault root |
