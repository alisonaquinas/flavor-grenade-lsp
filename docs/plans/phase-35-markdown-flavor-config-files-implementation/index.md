...
# Phase 35 Markdown Flavor Config Files Implementation Tickets
...
| [[TASK-357]] | Refactor effective flavor resolution around config outcome and Auto Detect | Task | `red` |
