...
Deliver unit, integration, BDD, verification, and validation evidence for the glfm flavor using [[docs/research/gitlab-flavored-markdown-analysis]] and ADR020 as the controlling specification.
...
- [x] Negative cross-flavor fixtures cover at least three inactive constructs for glfm, including Obsidian-only syntax where applicable.
