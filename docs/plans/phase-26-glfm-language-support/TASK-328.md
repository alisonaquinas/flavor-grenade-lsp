...
Deliver diagnostics and LSP feature behavior for the glfm flavor using [[research/gitlab-flavored-markdown-analysis]] and ADR020 as the controlling specification.
