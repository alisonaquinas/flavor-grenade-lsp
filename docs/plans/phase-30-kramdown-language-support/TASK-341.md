...
Deliver unit, integration, BDD, verification, and validation evidence for the kramdown flavor using [[research/kramdown-analysis]] and ADR020 as the controlling specification.
