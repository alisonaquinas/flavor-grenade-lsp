...
- ADR constraint: [[docs/adr/ADR005-wiki-style-binding]] governs how link targets are resolved to file paths
...
|---|---|---|
| — | Navigation requirements | [[docs/requirements/functional/navigation]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR005-wiki-style-binding]] | Wiki-link style binding rules govern how cursor entities are resolved to file paths |
