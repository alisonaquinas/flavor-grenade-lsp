...
> [!INFO] `TASK-023` · Task · Phase 2 · Parent: [[FEAT-003]] · Status: `open`
...
- [[TASK-022]] — `shutdownRequested` flag is set by the shutdown handler

**Unblocks:**

- [[TASK-029]] — Integration tests exercise the full shutdown → exit sequence
