...
> [!INFO] `TASK-020` · Task · Phase 2 · Parent: [[FEAT-003]] · Status: `open`
...
|---|---|---|
| — | LSP capability negotiation | [[docs/plans/phase-02-lsp-transport]] |
...
- [[TASK-021]] — `initialized` notification follows `initialize` response
