...
> [!INFO] `TASK-017` · Task · Phase 2 · Parent: [[FEAT-003]] · Status: `open`
...
|---|---|---|
| — | Transport framing correctness | [[docs/plans/phase-02-lsp-transport]] |
...
- [[TASK-019]] — JSON-RPC dispatcher requires a working reader to receive messages
