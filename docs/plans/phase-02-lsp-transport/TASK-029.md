...
> [!INFO] `TASK-029` · Task · Phase 2 · Parent: [[FEAT-003]] · Status: `open`
...
|---|---|---|
| — | Phase 2 gate verification | [[docs/plans/phase-02-lsp-transport]] |
...
- [[TASK-028]] — Full `LspModule` must be wired before end-to-end tests can run
