...
|---|---|---|
| — | EmbedResolver unit test coverage for all resolution paths | [[docs/requirements/functional/embed-resolution]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Embed resolution follows OFM syntax |
| [[docs/adr/ADR013-vault-root-confinement]] | Asset paths in tests must stay within mocked vault root |
