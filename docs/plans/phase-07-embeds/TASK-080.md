...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Hover is scoped to OFM embed syntax |
| [[docs/adr/ADR013-vault-root-confinement]] | Hover content must not leak server-local paths |
