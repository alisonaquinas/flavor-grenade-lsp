...
|---|---|---|
| — | Go-to-definition for embed targets including assets and sub-targets | [[docs/requirements/functional/embed-resolution]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Definition handling scoped to OFM embed syntax |
| [[docs/adr/ADR013-vault-root-confinement]] | File URIs for image embeds must be within vault root |
