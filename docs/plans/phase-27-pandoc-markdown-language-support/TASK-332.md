...
# Add Pandoc Markdown tests and validation evidence

## Description

Deliver unit, integration, BDD, verification, and validation evidence for the pandoc flavor using [[docs/research/pandoc-markdown-deep-research-report]] and ADR020 as the controlling specification.
...
> RED coverage will assert Pandoc local syntax, inactive Obsidian syntax,
> spawned-server propagation, completion/symbol/fold/token surfaces, and
> bibliography-bound citation classification before implementation changes are
> made.
