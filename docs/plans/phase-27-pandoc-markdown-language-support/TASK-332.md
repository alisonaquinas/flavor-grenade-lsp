...
Deliver unit, integration, BDD, verification, and validation evidence for the pandoc flavor using [[research/pandoc-markdown-deep-research-report]] and ADR020 as the controlling specification.
