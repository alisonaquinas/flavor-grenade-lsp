...
Deliver parser/profile semantics for the pandoc flavor using [[research/pandoc-markdown-deep-research-report]] and ADR020 as the controlling specification.
