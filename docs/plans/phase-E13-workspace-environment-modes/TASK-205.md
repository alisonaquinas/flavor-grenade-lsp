...
> [!INFO] `TASK-205` - Task - Phase E13 - Parent: [[FEAT-031]] - Status: `done`
...
|---|---|---|
| `Extension.Workspace.EnvironmentModes` | Restricted Mode has explicit no-spawn behavior | [[docs/requirements/functional/vscode-extension-parity]] |
| `Extension.Status.Diagnostics` | Disabled state is visible through status UI | [[docs/requirements/functional/vscode-extension-parity]] |
