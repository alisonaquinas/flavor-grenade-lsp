...
| W8    | Commonloom Content Pipeline | 🔎 in-review | TASK-279 removed `website/src/content/pipeline/commonloom` and the full local W8 gate passed; PR #65 CI is the final completion gate. Prior PR #64 merged at `9569e37` with green CI. | 2026-05-10 | — |
