...
|---|---|---|
| `Security.Vault.PathConfinement` | Canonicalize and vault-root-check every old and new path | [[docs/requirements/functional/security-vault-confinement]] |
| `Security.Vault.RenameConfinement` | Cancel rename and move edits that escape the vault root | [[docs/requirements/functional/security-vault-confinement]] |
