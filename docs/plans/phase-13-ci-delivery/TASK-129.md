...
|---|---|---|
| — | Single-file binary packaging with embedded runtime | [[docs/requirements/operational/ci-cd]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR008-oidc-publishing]] | Binary build is prerequisite for release workflow |
