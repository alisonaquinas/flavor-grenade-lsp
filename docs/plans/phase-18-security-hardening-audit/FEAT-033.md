...
| [[plans/phase-18-security-hardening-audit/BUG-040]] | Extension CI package-target check lacks bundled server binary | in-progress |
| [[plans/phase-18-security-hardening-audit/BUG-041]] | BDD file watcher scenario fails on Linux CI precondition | in-progress |
