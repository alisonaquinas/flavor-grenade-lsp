...
Deliver diagnostics and LSP feature behavior for the commonmark flavor using [[research/commonmark-and-original-markdown]] and ADR020 as the controlling specification.
