...
| [[TASK-318]] | Implement CommonMark parser semantics | Task | `red` |
| [[TASK-319]] | Add CommonMark diagnostics and LSP features | Task | `red` |
| [[TASK-320]] | Add CommonMark tests and validation evidence | Task | `red` |
