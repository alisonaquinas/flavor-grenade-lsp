...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR005-wiki-style-binding]] | Link style variants must be preserved, not converted, during rename |
| [[docs/adr/ADR013-vault-root-confinement]] | New file URIs must remain within vault root |
