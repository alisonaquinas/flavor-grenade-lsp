...
> [!INFO] `TASK-146` · Task · Phase E3 · Parent: [[FEAT-017]] · Status: `done`
...
- See also: [[docs/plans/phase-E3-status-bar-commands]] — full code listing for the final `extension.ts`
...
|---|---|---|
| — | Extension UX layer; wires all E3 features into the activation lifecycle | [[docs/requirements/index]] |
