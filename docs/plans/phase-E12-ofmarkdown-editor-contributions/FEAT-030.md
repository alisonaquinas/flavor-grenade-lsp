...
| Ticket | Title | Status |
|---|---|---|
| [[TASK-201]] | Add OFMarkdown snippets | `green` |
| [[TASK-202]] | Tune OFMarkdown language configuration | `green` |
| [[TASK-203]] | Add OFMarkdown-scoped keybindings | `green` |
| [[TASK-204]] | Test generic Markdown isolation | `green` |
