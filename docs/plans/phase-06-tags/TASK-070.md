...
|---|---|---|
| — | Find all vault occurrences of a given tag | [[docs/requirements/functional/tag-indexing]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Tag find-references is scoped to OFM syntax only |
