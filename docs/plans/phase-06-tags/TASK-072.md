...
- See also: `bdd/features/tags.feature`, [[docs/adr/ADR002-ofm-only-scope]]
...
|---|---|---|
| — | Code action to migrate inline tag to frontmatter | [[docs/requirements/functional/tag-indexing]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Code action is scoped to OFM inline tag syntax |
