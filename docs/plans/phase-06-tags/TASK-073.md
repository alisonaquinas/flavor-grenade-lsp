...
|---|---|---|
| — | Frontmatter tags indexed alongside inline tags | [[docs/requirements/functional/tag-indexing]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR002-ofm-only-scope]] | Tag handling is scoped to OFM syntax including YAML frontmatter |
