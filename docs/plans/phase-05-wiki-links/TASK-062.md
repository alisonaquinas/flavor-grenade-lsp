...
|---|---|---|
| — | Find-references requirements | [[docs/requirements/functional/wiki-link-resolution]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR005-wiki-style-binding]] | DefKey construction and RefGraph query semantics |
