...
- See also: [[docs/adr/ADR005-wiki-style-binding]], [[docs/adr/ADR003-vault-detection]]
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR005-wiki-style-binding]] | Integration tests must cover all three link styles |
| [[docs/adr/ADR003-vault-detection]] | Fixture vault must include a valid vault marker (.obsidian/) |
