...
|---|---|---|
| — | Wiki-link completion requirements | [[docs/requirements/functional/wiki-link-resolution]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR005-wiki-style-binding]] | Link style formatting for completion insertText |
