...
- [[tickets/TASK-059]] — LinkResolver must be implemented before DefinitionService can use it

**Unblocks:**

- [[tickets/TASK-065]] — LspModule registers DefinitionService capability
