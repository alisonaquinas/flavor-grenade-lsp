...
|---|---|---|
| — | Go-to-definition requirements | [[docs/requirements/functional/wiki-link-resolution]] |
...
| ADR | Decision |
|---|---|
| [[docs/adr/ADR005-wiki-style-binding]] | Definition target resolution binding |
