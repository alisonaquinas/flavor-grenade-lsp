...
**Maps to:** Extension.Activation.VaultPrecision
...
**Maps to:** Extension.CommandBridges.NativeUI
...
**Maps to:** Extension.Tests.HostCoverage
...
**Maps to:** Extension.Marketplace.OFMProof
...
**Maps to:** Extension.Status.Diagnostics
