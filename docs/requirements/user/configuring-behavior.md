---
title: Configuring Behavior User Requirements
tags:
  - requirements/user/configuring-behavior
aliases:
  - Configuring Behavior
  - Configuring Behaviour
---

# Configuring Behavior User Requirements

> [!NOTE] Scope
> These user requirements cover how vault authors tune the server's behavior to match their workflow. Implementation details are in [[configuration]]. The former `configuring-behaviour` slug was renamed for US-English terminology consistency.

---

## User.Config.CustomizeLinkStyle

**Tag:** User.Config.CustomizeLinkStyle
...
**Ambition:** The configured limit is honored exactly in every completion context — wiki-links, tags, block refs, and callout types — so authors with large vaults are never overwhelmed and authors with small vaults are never under-served.
