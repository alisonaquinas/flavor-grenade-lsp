...
> [!NOTE] Scope
> These user requirements cover how vault authors expect the server to discover and work with their vault without manual configuration. Implementation details are in [[docs/requirements/functional/workspace]].
