...
> [!NOTE] Scope
> These user requirements cover how vault authors move between notes, discover connections, and understand the structure of their knowledge graph. Implementation details are in [[docs/requirements/functional/navigation]], [[docs/requirements/functional/wiki-link-resolution]], and [[docs/requirements/functional/block-references]].
