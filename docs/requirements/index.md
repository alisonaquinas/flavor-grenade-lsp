...
| **Extension.MarkdownFlavor.OverridePersistence** | Flavor overrides must persist to `.mdfattributes` for selected-file and directory scopes. | [[docs/requirements/functional/ofmarkdown-language-mode]] |
