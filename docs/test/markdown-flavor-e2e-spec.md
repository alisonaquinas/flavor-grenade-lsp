...
| MF-E-003 | `docs/bdd/features/vscode-extension.feature` | LanguageClient serves Markdown documents while flavor state changes without relying on custom language ids. |
