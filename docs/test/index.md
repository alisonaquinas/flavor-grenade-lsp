...
| `src/resolution/__tests__/ref-graph-markdown-links.test.ts` | Unit | Tests RefGraph indexing for Markdown document refs, image refs, label refs, definitions, and external URL suppression | `Parity.MarkdownLinks.ReferenceGraph`, `Parity.MarkdownLinks.LocalResolution` | Phase 14 |
