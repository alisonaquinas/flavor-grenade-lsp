...
| Sanitization | Repository-relative paths and summarized references only; no note bodies, `.fgignore`/`.fgattributes` contents, environment variables, tokens, local user paths, or raw server output included |
