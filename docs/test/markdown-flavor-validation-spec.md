...
| MF-VA-007 | `docs/test/evidence/markdown-structured-profile-review.md` | Reviewer confirms Keep a Changelog, Common Changelog, and MADR remain structured profile flags, have smoke fixtures in every configured and project-config-absent inference workspace, and are backed by research sources. |
...
body text, frontmatter values, project config contents, environment
