...
This directory contains small Markdown fixtures that show how the skill reports
flavor decisions, config evidence, and structured variants. They are examples
for agents and humans, not exhaustive server test fixtures.
