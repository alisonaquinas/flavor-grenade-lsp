# 1. Use structured profile overlays for GitHub Flavored Markdown smoke fixtures
...
The smoke test needs a MADR example that can be inferred from its folder placement while preserving the base GitHub Flavored Markdown flavor.
...
GFM evidence: task lists and tables are present.
