# 1. Use structured profile overlays for Pandoc Markdown smoke fixtures
...
The smoke test needs a MADR example that can be inferred from its folder placement while preserving the base Pandoc Markdown flavor.
