# 1. Use structured profile overlays for Markdown Extra smoke fixtures
...
The smoke test needs a MADR example that can be inferred from its folder placement while preserving the base Markdown Extra markdown flavor.
