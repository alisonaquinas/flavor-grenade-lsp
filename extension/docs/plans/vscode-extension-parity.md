...
| E9 Extension tests | In review: extension-host tests cover `Extension.Tests.HostCoverage`, `Extension.LanguageMode.MembershipRefresh`, command bridges, and status/failure surfaces |
