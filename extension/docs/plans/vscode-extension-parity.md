...
| E15 Markdown flavor selector and settings | Planned: add selector, `flavorGrenade.markdownFlavor`, auto-detect, persistence, manual-language safety, and server propagation |
