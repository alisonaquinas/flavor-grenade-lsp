...
| User.ExtensionFlavor.PersistChoice | Keep a manual flavor choice at the right VS Code settings scope | [markdown-flavors](markdown-flavors.md) | Extension.MarkdownFlavor.OverridePersistence |
