...
| GAP-E-004 | `Extension.MarkdownFlavor.AutoDetection`; `EXT-MF-U-004`, `EXT-MF-U-005` | Marker/server membership results map to language promotion, not effective flavor. | Auto detection must resolve `obsidian`, `.fgattributes flavor=auto`, strong syntax inference, or `commonmark`. | High |
