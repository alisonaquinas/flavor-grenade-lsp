...
| EXT-MF-VF-011 | structured profile fixture inventory checks | CI/local gates protect Keep a Changelog, Common Changelog, and MADR fixture inventory under every `.fgattributes`-configured and config-absent inference smoke workspace. |
