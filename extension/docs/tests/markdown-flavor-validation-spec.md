...
| EXT-MF-VA-002 | `extension/docs/tests/evidence/markdown-flavor-fgattributes-scope.md` | `.fgattributes` receives the expected selected-file or directory-scope rule for override flows. |
...
| `extension/docs/tests/evidence/markdown-flavor-fgattributes-scope.md` | `.fgattributes` inspection for selected-file override, directory `/*.md` override, standalone selected-file override, and Auto Detect reset. |
